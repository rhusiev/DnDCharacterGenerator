...
% HEADER INFORMATION
\rput[l](347.87600658,977){\begin{fitbox}{3.8cm}{15pt}{\Large} \entryfont \textcolor{text-color}{\ClassValue} \end{fitbox}}
\rput[l](498.21666949,977){\begin{fitbox}{3.3cm}{15pt}{\Large} \entryfont \textcolor{text-color}{\BackgroundValue} \end{fitbox}}
\rput[l](627.23599959,977){\begin{fitbox}{3.3cm}{15pt}{\Large} \entryfont \textcolor{text-color}{\PlayerNameValue} \end{fitbox}}
...
{
	\rput[lt](288,560){%
		\begin{fitbox}{167pt}{6.7cm}{\normalsize}%
			\entryfont \RaggedRight \setlength{\parindent}{0pt}%
			\noindent%
			\makebox[167pt][l]{%
				\parbox{167pt}{%
					\hbadness=10000 \hfuzz=10pt%
					\RaggedRight\setlength{\parindent}{0pt}\entryfont
					\begin{DndTable}{X l >{\raggedright\arraybackslash}X}
						\tiny \textcolor{tertiary-indicator-color}{\textsf{\weaponnameatname}} &
						\tiny \textcolor{tertiary-indicator-color}{\textsf{\atkbonusatname}}   &
						\tiny \textcolor{tertiary-indicator-color}{\textsf{\damagetypeatname}}
						\WeaponsHeld
					\end{DndTable}%
				}%
			}%
...
\rput[lt](37,220){\begin{fitbox}{168pt}{4.65cm}{\normalsize} \entryfont \RaggedRight\setlength{\parindent}{0pt} \textcolor{text-color}{\OtherProficienciesLanguagesValue} \end{fitbox}}
\rput[lt](353,264){\begin{fitbox}{118pt}{5.8cm}{\normalsize} \entryfont \RaggedRight\setlength{\parindent}{0pt} \textcolor{text-color}{\EquipmentValue} \end{fitbox}}
\rput[lt](541,542){\begin{fitbox}{168pt}{13.2cm}{\normalsize} \entryfont \RaggedRight\setlength{\parindent}{0pt} \textcolor{text-color}{\FeaturesTraitsValue} \end{fitbox}}

% PERSONALITY / BACKGROUND
\ifSingleBackground
	\rput[lt](551,870){\begin{fitbox}{153pt}{7.5cm}{\footnotesize} \entryfont \RaggedRight\setlength{\parindent}{0pt} \textcolor{text-color}{\CharacterbackgroundValue} \end{fitbox}}
\else
	\rput[lt](551,870){\begin{fitbox}{153pt}{1.8cm}{\footnotesize} \entryfont \RaggedRight\setlength{\parindent}{0pt} \textcolor{text-color}{\PersonalityTraitsValue} \end{fitbox}}
	\rput[lt](551,778){\begin{fitbox}{153pt}{1.35cm}{\footnotesize} \entryfont \RaggedRight\setlength{\parindent}{0pt} \textcolor{text-color}{\IdealsValue} \end{fitbox}}
	\rput[lt](551,704){\begin{fitbox}{5.4cm}{1.3cm}{\footnotesize} \entryfont \RaggedRight\setlength{\parindent}{0pt} \textcolor{text-color}{\BondsValue} \end{fitbox}}
	\rput[lt](551,631){\begin{fitbox}{5.4cm}{1.3cm}{\footnotesize} \entryfont \RaggedRight\setlength{\parindent}{0pt} \textcolor{text-color}{\FlawsValue} \end{fitbox}}
\fi
